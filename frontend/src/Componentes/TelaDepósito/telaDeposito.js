...
function TelaDeposito(){
    ...
    const [isCréditoModalOpen, setIsCreditoModalOpen] = useState(false);
        ...
        <div>
            ...
            <div className="functions-container">
                ...
                <div className="functions-card-deposito">
                    <p>Selecione a forma de depósito</p>
                    <section className="botoes-deposito">
                        <button onClick={handleOpenPixModal}>
                        ...
                        <button onClick={handleOpenCreditoModal}>
